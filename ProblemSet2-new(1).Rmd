...
## Abstract
The more the number of people in a given household, the more likely that the family is highly sensitive to socioeconomic conditions. If the more the children the larger the household, and the higher the age the more the likely to more family members, old spouses at the age of 50 and above are more sensitive to socioeconomic conditions as compared to young married couples. The aim of the study is to quantitatively evaluate the condition based on historical data on surveys conducted from families in Canada. All the data used in the analysis was collected in year 2017. The socioeconomic conditions considered in the study were education, income per family, and occupation. After running the linear regression model on the chosen variables, age had strong statistical significance to the total number of children. On the other hand, household size and conditions variables also had high statistical significance to the total number of children in a household. Therefore, the main conclusion was that the higher the age the higher the sensitivity to socioeconomic conditions as well as household size. 
